      ...
      try{
        columnContainerCollectionArray.map(x => {
          if (x.children[2].childElementCount === 1){
            ...
            buttonContainer.setAttribute("style", 'background-color: #0e2a4c;color: white;font-family: "Roboto", "Helvetica", "Arial", sans-serif;font-weight: 400; font-size: 14px; padding: 5px;');
